...
class MiCOM_P746(object):
	...
	def configureCoupler(
		...
		equipmentlist = ['None', 'Breaker Only', 'Isolator Only', 'Breaker&Isolator']
	...
	def setID2(self, IfMin):
		...
		if not Iset <= (0.8 * IfMin):
			raise ValueError('Setting above 80% Ifmin, check load currents or set pickup manually')
